...
//         // Manager gets salary=2000, bonus=500 by default
...
//         if (!requirePermission(CREATE_STAFF)) return; // only logged in staff can add
...
import user.SellerStaff;
import user.Staff;
import user.StaffFilter;   // ✅ ADDED — needed for Task 3 and Task 4
